# Welcome to the **AISS-Lab** GitHub Page

![polito](resources/logo_polito.jpg)

## About Us
**AISS-Lab** is a collaborative group of students working on projects related to the **Advanced Information System Security** course. 
...
| Eric Ruiz Giménez | [![GitHub](https://img.shields.io/badge/GitHub-Profile-informational?logo=github)](https://github.com/thismanera) | [![LinkedIn](https://img.shields.io/badge/LinkedIn-Profile-blue?logo=linkedin)](https://www.linkedin.com/in/eric-ruiz-gimenez/) | 
...
## Repositories
<!-- TODO: update -->
1. [**repo-name**](https://github.com/AISS-Lab/repo-name) - Repository containing the code and resources for the ...
<!-- *(Add or remove repositories as needed) *-->

## How to Contribute
If you are a member of **AISS-Lab**, feel free to contribute by cloning the repositories, creating new branches for your work, and submitting pull requests for review. All contributions are welcome and reviewed by the team members to ensure the quality and consistency of our projects.
...
- **Eric Ruiz Giménez**: [eric.ruizgimenez@studenti.polito.it](mailto:eric.ruizgimenez@studenti.polito.it)
...
- **Website**: [Advanced Information System Security (AISS) 2025/2026](https://didattica.polito.it/pls/portal30/gap.pkg_guide.viewGap?p_cod_ins=02GYYUV&p_a_acc=2026&p_header=S&p_lang=IT&multi=N)
...
Thank you for visiting the **AISS-Lab** GitHub page! Feel free to explore our projects and contribute to our open-source efforts.
